...
class ParsedownExtended extends \ParsedownExtendedParentAlias
{
    ...
    /** @var array|null $characterMap Cached character map for manual transliteration */
    private static ?array $characterMap = null;

    /** @var \Transliterator|null $transliterator Cached Transliterator instance */
    ...
    protected function manualTransliterate(string $text): string
    {
        ...
        return strtr($text, self::$characterMap);
    }
