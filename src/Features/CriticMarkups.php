...
use BenjaminHoegh\ParsedownExtended\Components\Inlines\CriticMarkup;

final class CriticMarkups implements StateBearer
{
    /** @var State */
    private $State;
    ...
    public function __construct(?StateBearer $StateBearer = null)
    {
        ...
        $InlineTypes = $State->get(InlineTypes::class)
            ->addingHighPrecedence('{', [CriticMarkup::class]);
