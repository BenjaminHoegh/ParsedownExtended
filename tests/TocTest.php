...
//     {
//         $this->parsedownExtended->settings()->get('headings.auto_anchors', true);
//         $this->parsedownExtended->settings()->get('toc', true);
...
//     {
//         $this->parsedownExtended->settings()->set('headings.auto_anchors', true);
//         $this->parsedownExtended->settings()->set('toc', false);
...
//     {
//         $this->parsedownExtended->settings()->set('headings.auto_anchors', true);
//         $this->parsedownExtended->settings()->set('toc.headings', ['h1', 'h2']);
